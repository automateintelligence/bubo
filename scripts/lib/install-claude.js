...
// The command instructs the model to run the CLI via its Bash tool rather than
// pre-executing a !\`...\` line. Textual $ARGUMENTS substitution into an
// auto-executed shell line is a shell-injection channel (quoting cannot save
// it); as a tool call, arguments stay arguments.
